...
import WFC.TileSet.Symmetry (OrientationCount(..), OrientationIndex(..), RotationSteps(..), Symmetry(..), parseSymmetry, cardinality, distinctOrientations, rotateIndex, rotateIndexBy)
